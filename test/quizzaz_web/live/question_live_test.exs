defmodule QuizzazWeb.QuestionLiveTest do
  ...
  @create_attrs %{answer_1: "some answer_1", answer_2: "some answer_2", answer_3: "some answer_3", answer_4: "some answer_4", correct_answer: 42, prompt: "some prompt"}
  ...
  defp fixture(:question) do
    {:ok, question} = Games.create_question(@create_attrs)
    question
  end
